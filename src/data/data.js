...
export const LEVELS = {
  ...
  'old-school': {
    ...
    grades: [
      ...
      { id:'f5', num: <i className="bi bi-mortarboard-fill" style={{fontSize:40}}></i>, label:'English Set Books', age:'Summary and Questions', driveId:'1D5GXktuenUJN9BRN1lnHP2cT5fX8gLDM', subjects:['English','Kiswahili','Mathematics','Biology','Chemistry','Physics','History','Geography','Business Studies','Computer Science','Art & Design','Music'] },
      { id:'f6', num: <i className="bi bi-mortarboard-fill" style={{fontSize:40}}></i>, label:'Kiswahili Set Books', age:'Summary and Questions', driveId:'1k692aT0dWN9J3sqH5dTER1zpKmqVJKMx', subjects:['English','Kiswahili','Mathematics','Biology','Chemistry','Physics','History','Geography','Business Studies','Computer Science','Art & Design','Music'] },
    ],
  },
  'exam-revision': {
