...
export const LEVELS = {
  ...
  'junior-secondary': {
    ...
    grades: [
      { id:'g7', num:'📚', label:'Grade 7', age:'Notes and Past papers', driveId:'1HGV_tzq1lW5syxM-gmbO4_jUIaGlUvuo', subjects:['English','Kiswahili','Mathematics','Integrated Science','Social Studies','Business Studies','Agriculture','Computer Science','Creative Arts','Physical Education','Religious Education','Foreign Language'] },
      { id:'g8', num:'📚', label:'Grade 8', age:'Notes and Past papers', driveId:'1CzVAb1Ccl1xNllv387VEJLuZq9skVboh', subjects:['English','Kiswahili','Mathematics','Integrated Science','Social Studies','Business Studies','Agriculture','Computer Science','Creative Arts','Physical Education','Religious Education','Foreign Language'] },
  ...
  'exam-revision': {
    ...
    grades: [
      { id:'kcpe',  num:'', label:'KCPE',  age:'Primary Exit Exam', driveId:'1YcRs0GDdYu5nzXDsPQcU-7YBPUF60bwn',  subjects:['English','Kiswahili','Mathematics','Science','Social Studies & CRE'] },
      { id:'kpsea', num:'', label:'KPSEA', age:'Grade 6 Exit Exam', driveId:'1268zQYpP0aXQm5jeWJJhbFTezOQKwXQB',  subjects:['English','Kiswahili','Mathematics','Science & Technology','Social Studies','Creative Arts','Physical & Health Education'] },
      { id:'kjsea', num:'', label:'KJSEA', age:'Grade 9 Exit Exam', driveId:'1mmML5c8CJC-RYbDCgYNS7DDj8e6EuTMb',  subjects:['English','Kiswahili','Mathematics','Integrated Science','Social Studies','Business Studies','Agriculture','Computer Science','Creative Arts','Physical Education'] },
      { id:'kcse',  num:'', label:'KCSE',  age:'Secondary Exit Exam', driveId:'1iXJW8CmNDKWNLQ39H9tCt-D4wmVowJfX', subjects:['English','Kiswahili','Mathematics','Biology','Chemistry','Physics','History','Geography','Business Studies','Computer Studies'] },
    ],
  },
  'teacher-resources': {
    label: 'Teacher Resources', icon: '👩‍🏫', color: 'lc-teal',
    grades: [
      { id:'tr-pp', num:'', label:'Pre-Primary',      age:'PP1 & PP2',   driveId:'1VgEYZGT2DIdnfMYI9S2luAblBUZs6tjY',  subjects:['Schemes of Work','Lesson Plans','Assessment Rubrics','Activity Sheets','KICD Syllabus'] },
  ...
  'lesson-plans': {
    label: 'Lesson Plans', icon: '�', color: 'lc-blue',
    grades: [
      { id:'tr-pp', num:'', label:'pp',      age:'PP1 & PP2',   driveId:'1VgEYZGT2DIdnfMYI9S2luAblBUZs6tjY',  subjects:['Schemes of Work','Lesson Plans','Assessment Rubrics','Activity Sheets','KICD Syllabus'] },
      { id:'tr-lp', num:'', label:'Lp',    age:'Grade 1–3',   driveId:'1VgEYZGT2DIdnfMYI9S2luAblBUZs6tjY',  subjects:['Schemes of Work','Lesson Plans','Assessment Rubrics','Activity Sheets','KICD Syllabus','Record of Work'] },
      { id:'tr-up', num:'', label:'Up',    age:'Grade 4–6',   driveId:'1VgEYZGT2DIdnfMYI9S2luAblBUZs6tjY',  subjects:['Schemes of Work','Lesson Plans','Assessment Rubrics','Homework Sheets','KICD Syllabus','Record of Work'] },
      { id:'tr-js', num:'', label:'Jss', age:'Grade 7–9',   driveId:'1VgEYZGT2DIdnfMYI9S2luAblBUZs6tjY',  subjects:['Schemes of Work','Lesson Plans','Assessment Rubrics','CAT Papers','KICD Syllabus','Record of Work','Remedial Activities'] },
      { id:'tr-ss', num:'', label:'Hs',      age:'Grade 10–12', driveId:'1VgEYZGT2DIdnfMYI9S2luAblBUZs6tjY',  subjects:['Schemes of Work','Lesson Plans','Assessment Rubrics','CAT Papers','KICD Syllabus','Record of Work','KCSE Prediction Papers'] },
    ],
  },
};
